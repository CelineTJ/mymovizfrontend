...
function Home() {
  ...
  // faites une requête vers le backend webservice
  //afin de remplacer le tableau d’objet moviesData par les données renvoyées par l’API.
  ...
  useEffect(() => {
    fetch("http://mymovizbackend-88ws.vercel.app/movies")
